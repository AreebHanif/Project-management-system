      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a href="https://facebook.com/areeb.hanif.3" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-white transition-colors">
                ...
                <li>
                  <a href="https://instagram.com/areeb.official1/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-white transition-colors">
                ...
                <li>
                  <a href="https://github.com/AreebHanif" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-white transition-colors">
                ...
                <li>
                  <a href="https://linkedin.com/in/areebhanif" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-white transition-colors">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; 2025 ProjectFlow. All rights reserved. Built by Muhammad Areeb
            </p>
          </div>
        </div>
      </motion.footer>
