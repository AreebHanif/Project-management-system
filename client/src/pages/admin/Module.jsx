...
const Module = ({
  ...
  return (
    <div
      className={`bg-white rounded-3xl border border-gray-100 transition-all duration-300 transform min-h-[300px] flex flex-col relative overflow-hidden group ${
        module.active
      ...
      <div className="p-7 pb-5 flex-shrink-0 relative z-10">
        ...
        <button
          ...
          className={`w-full text-left ${
            !module.active ? "cursor-not-allowed" : "cursor-pointer"
          }`}
        >
          <Link to={`${module._id}`}>
            <div className="flex items-center justify-between group/title">
              <h3
                className={`text-2xl font-bold leading-tight pr-3 transition-colors duration-300 ${
                  module.active
        ...
        <div className="flex-grow">
          <p
            className={`text-sm leading-relaxed line-clamp-4 mb-4 ${
              module.active ? "text-gray-600" : "text-gray-500"
            }`}
          >
            {module.description}
          </p>
